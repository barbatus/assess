/*
  ...
  - Added the required column `chatId` to the `Story` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "Story_chatId_key" ON "Story"("chatId");
